        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-3xl xl:text-4xl text font-bold text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
