        ...
        <section id="HERO" className="min-h-fit md:min-h-screen bg-radialBg bg-cover ">
            <div className="pt-28 md:pt-44 px-10 mx-auto container max-w-3xl pb-12 md:pb-20">
                <div className="flex flex-col justify-center items-center" data-aos="zoom-out" data-aos-duration="1000"
                    ...
                    <h1 id="head1" className="text-3xl md:text-4xl lg:text-6xl font-bold text-center my-2"
                        onMouseEnter={textEnter}
                        onMouseLeave={textLeave}
                    >Ashikur Rahman</h1>
                    <h2 className="text-2xl md:text-4xl font-bold text-center">
                        <Typewriter
                            words={['Front end developer', 'MERN Stack Web Developer', 'UI designer', 'Learner🤍']}
                            loop={5}
                            cursor
                            cursorStyle='_'
                            typeSpeed={70}
                    ...
                    <a href={myResume} className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-indigo-100 border border-indigo-500 rounded-lg shadow-sm cursor-pointer hover:text-white bg-gradient-to-br from-purple-500 via-indigo-500 to-indigo-500" download='Ashikur_Rahman_resume_Frontend_Developer'>
