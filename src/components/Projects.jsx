    ...
    return (
        <section id="PROJECTS" className='container relative my-10  md:mt-36 mb-[100px]'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center justify-center">
                ...
                {/* 2 */}
                <div className={`w-[100%] border-[#ffffff2c] border-[1px] h-[460px] rounded-md  relative bg-top bg-no-repeat bg-cover hover:bg-bottom ease-linear duration-[5000ms]  text-white mx-auto`}
                    data-aos="zoom-in-up"
                    data-aos-delay="150"
                    data-aos-duration="600"
                    data-aos-easing="ease-in-out">
                ...
                {/* 4 */}
                <div className={`w-[100%] border-[#ffffff2c] border-[1px] h-[460px] rounded-md  relative bg-top bg-no-repeat bg-cover hover:bg-bottom ease-linear duration-[5000ms]  text-white shadow-black shadow-lg mx-auto`}
                    data-aos="zoom-in-up"
                    data-aos-delay="200"
                    data-aos-duration="600"
                    data-aos-easing="ease-in-out">
                    ...
                    <div className={`group p-2 absolute left-4 bottom-4 bg-white/20 backdrop-blur-md w-11/12 rounded-md  hover:duration-300 ease-in-out hover:h-[50%] hover:w-[100%] overflow-hidden hover:left-0 hover:bottom-0 text-white`}>
                        ...
                        <div className="flex gap-3 py-2">
                            <a target="_blank" href="https://learners-hut.web.app/" rel="noreferrer" aria-label="live link" ><FaExternalLinkAlt /></a>
                            <a target="_blank" href="https://github.com/Ashikur540/Learners-Hut-Client" rel="noreferrer" aria-label="github"><FaGithub /></a>
                ...
                <div className={`w-[100%] border-[#ffffff2c] border-[1px] h-[460px] rounded-md  relative bg-top bg-no-repeat bg-cover hover:bg-bottom ease-linear duration-[5000ms] bg-projectThree text-white shadow-black shadow-lg mx-auto`}
                    ...
                    <div className={`group p-2 absolute left-4 bottom-4 bg-white/20 backdrop-blur-md w-11/12 rounded-md  hover:duration-300 ease-in-out hover:h-[50%] hover:w-[100%] overflow-hidden hover:left-0 hover:bottom-0 text-black`}>
                        ...
                        <div className="flex gap-3 py-2">
                            <a target="_blank" href="https://ashikur540.github.io/Fashion-Brand-Templete/" rel="noreferrer" aria-label="live link" ><FaExternalLinkAlt /></a>
                            <a target="_blank" href="https://github.com/Ashikur540/Fashion-Brand-Templete" rel="noreferrer" aria-label="github"><FaGithub /></a>
